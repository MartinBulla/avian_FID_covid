...
#+ gsfig_pred, fig.width=5, fig.height = 3.5
col__ = col_[3:7]
#p = 
ggplot(sp, aes(x = StringencyIndex, y = pred, col = Country)) +
  ...
  scale_colour_manual(values = col__, guide = guide_legend(reverse = TRUE, override.aes = list(size = 0)), 
  ...
  scale_fill_manual(values = col__, guide = "none") +
  theme_bw() +
  theme(
...
#+ gm_week_year, fig.width=8, fig.height = 8
