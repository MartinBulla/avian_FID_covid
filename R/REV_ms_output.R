...
if (save_plot == TRUE) {
  ggsave(here::here("Outputs/Fig_1_width-16cm.png"), gg_f1, width = 16, height = 6.5, unit = "cm", dpi = 600)
}
...
#' ***
#' 
#' ### Species trends for # of humans, Google Mobility and Stringency index
...
if (save_plot == TRUE) {
  ggsave(here::here("Outputs/Fig_S4_width-152mm_Google.png"), gtgx2, width = 15.24, height = 19, unit = "cm", dpi = 600)
}
...
if (save_plot == TRUE) {
  ggsave(here::here("Outputs/Fig_S5_width-152mm.png"), gsgx2, width = 15.24, height = 19, unit = "cm", dpi = 600)
}
...
if (save_plot == TRUE) {
  ggsave(here::here("Outputs/Fig_S6.png"), ggx3, width = 13.5, height = 17.5, unit = "cm", dpi = 600) # 11.43cm
}
grid::grid.draw(ggx3)
#' <a name="F_S6">
...
#'
#' ### Species-site specific relationships
#'
...
#' <a name="F_S7">
#' **Figure S7 | Variation in avian tolerance toward human numbers during escape trial across species and sites.**</a> Dots represent single escape distance observations of species at specific sites (e.g. specific park or cemetery) and not corrected for other factors such as starting distance of the observer. Dot colour highlights the country. Grey lines indicate locally estimated scatterplot smoothing (Loess). Depicted are only species-sites combinations with ≥ 10 escape trials. Panels are ordered alphabetically according to species names. The y-axes are on the log-scale.
#'
...
#' <a name="F_S8">
#' **Figure S8 | Variation in avian tolerance toward daily human numbers across species and sites.**</a> Dots represent single escape distance observations of species at specific sites (e.g. specific park or cemetery) and not corrected for other factors such as starting distance of the observer. Dot colour highlights the country. Red lines indicate locally estimated scatterplot smoothing (Loess). Depicted are only species-sites combinations with ≥ 10 escape trials. Panels are ordered alphabetically according to species names. The y-axes are on the log-scale.
#'
...
#' <a name="F_S9">
#' **Figure S9 | Variation in avian tolerance toward weekly human numbers across species and sites.**</a> Dots represent single escape distance observations of species at specific sites (e.g. specific park or cemetery) and not corrected for other factors such as starting distance of the observer. Dot colour highlights the country. Grey lines indicate locally estimated scatterplot smoothing (Loess). Depicted are only species-sites combinations with ≥ 10 escape trial. Panels are ordered alphabetically according to species names. The y-axes are on the log-scale.
#'
...
#+ Fig_4, fig.width=6.3, fig.height = 8.7
theme_mb2 <-
  theme_MB +
  theme(
    plot.subtitle = element_text(size = 7),
...
# combine & export
sshh <- ggarrange(
  p_hg_o +  rremove("ylab") + xlab(''), p_hs_o + rremove("ylab") + xlab(''), 
   p_hg_ln + rremove("ylab"), p_hs_ln +  rremove("ylab"),
  ncol = 2, nrow = 2
  ) + theme(plot.margin = margin(r = 2)) 

fig_2 = annotate_figure(sshh,
...
#+ Fig_3_gsfig_pred, fig.width=7/2.5, fig.height = 6/2.5
# Predictions
l <- list()
...
if (save_plot == TRUE) {
  ggsave(here::here("Outputs/Fig_3_width-70mm.png"), p + theme(plot.subtitle = element_blank()), width = 7, height = 6, unit = "cm", dpi = 600)
}
