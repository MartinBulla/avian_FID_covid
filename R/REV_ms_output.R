...
if (save_plot == TRUE) {
  ggsave(here::here("Outputs/Fig_S3_width-152mm_humans.png"), gth2, width = 15.25, height = 6 * 19 / 9, unit = "cm", dpi = 600)
}
grid::grid.draw(gth2)
#' <a name="F_S3">
...
#'
#+ Fig_S4_species_google, fig.width=0.393701*15.25, fig.height = 0.393701*19
...
if (save_plot == TRUE) {
  ggsave(here::here("Outputs/Fig_S4_width-152mm_Google.png"), gtg2, width = 15.24, height = 19, unit = "cm", dpi = 600)
}
grid::grid.draw(gtg2)
#' <a name="F_S4">
...
#+ Fig_4, fig.width=16*0.393701, fig.height = 11*0.393701
...
# combine & export
sshh <- ggarrange(
  p_hg_o +  rremove("ylab") + xlab('') + theme(plot.margin = margin(r = 2)) , p_hs_o + rremove("ylab") + xlab('')+ theme(plot.margin = margin(r = 2)) , 
  p_hg_ln + rremove("ylab")+ theme(plot.margin = margin(r = 2)) , 
  p_hs_ln +  rremove("ylab")+ theme(plot.margin = margin(r = 2)) ,
  ncol = 2, nrow = 2
  )
...
if (save_plot == TRUE) {
ggsave(file = here::here("Outputs/Fig_2_width-160mm.png"), fig_2, width = 16, height = 8, units = "cm")
}
