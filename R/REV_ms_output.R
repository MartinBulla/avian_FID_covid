...
#' Continuous variables were z-transformed. For model descriptions see legend of Fig. [1](#F_1), for descriptions of variables Methods of the paper. Residual indicates residual variance.
#' 
#' ***
#' 
