...
# supplementary Sable S_fid_period  
  ...
  out_FID_c[, effect := gsub("scale\\(Covid\\)", "Periiod", effect)]
...
#' **Table S2b | Alternative models on escape distance given Stringency** </a>
    ...
    out2 %>%
      kbl() %>%
      kable_paper("hover", full_width = F)
#' Continuous variables were z-transformed (scale). For model descriptions see legend of Figure S6. Note that (1a) model is the one reported in the main text.
#' 
#' <a name="T_S2c">
