#' ---
#' title: "Supporting code, figures and tables for  <br>  Urban birds' flight responses were largely unaffected by the COVID-19 shutdowns"
#' author: "Martin Bulla"
#' date: "`r Sys.time()`"
#' output:
#'     html_document:
...
#' Continuous variables were z-transformed. For model descriptions see legend of Figure 1.
#' 
...
#'
    ...
    out1 %>%
       kbl() %>%
       kable_paper("hover", full_width = F)
#' Continuous variables were z-transformed (scale). For model descriptions see legend of Figure 1. Note that (1a) model is the one reported in the main text.
#'
#' <a name="T_S2b">
